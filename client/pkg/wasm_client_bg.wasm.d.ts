...
export function __wbg_wasmlocation_free(a: number): void;
export function wasmstate_new(): number;
export function wasmstate_place_piece(a: number, b: number, c: number, d: number, e: number): number;
export function wasmstate_place_piece_with_id(a: number, b: number, c: number, d: number, e: number, f: number): number;
export function wasmstate_step(a: number): void;
export function wasmstate_get_win_condition(a: number): number;
export function wasmstate_get_game(a: number): number;
export function wasmstate_get_entities(a: number): number;
export function wasmstate_get_entity_by_id(a: number, b: number): number;
export function draw_private_hand(a: number, b: number, c: number, d: number): number;
