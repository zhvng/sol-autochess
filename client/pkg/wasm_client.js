...
/**
*/
export const UnitTypeWasm = Object.freeze({ Wolf:0,"0":"Wolf",Bear:1,"1":"Bear",Bull:2,"2":"Bull", });
/**
*/
export const ControllerWasm = Object.freeze({ Initializer:0,"0":"Initializer",Opponent:1,"1":"Opponent",Contract:2,"2":"Contract",Graveyard:3,"3":"Graveyard", });
/**
*/
export class Hash {
...
export class WasmLocation {
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_wasmlocation_free(ptr);
    }
}
/**
*/
export class WasmState {
    ...
    * @returns {number}
    */
    place_piece(x, y, unit_type, player_type) {
        var ret = wasm.wasmstate_place_piece(this.ptr, x, y, unit_type, player_type);
        return ret;
    }
    /**
    * @param {number} id
    ...
    */
    get_game() {
        var ret = wasm.wasmstate_get_game(this.ptr);
        return takeObject(ret);
    }
    /**
    * @returns {any}
    */
    get_entities() {
        var ret = wasm.wasmstate_get_entities(this.ptr);
        return takeObject(ret);
    }
    /**
    * @param {number} id
    ...
    */
    get_entity_by_id(id) {
        var ret = wasm.wasmstate_get_entity_by_id(this.ptr, id);
        return takeObject(ret);
    }
}
